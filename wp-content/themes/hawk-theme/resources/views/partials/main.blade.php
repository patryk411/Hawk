            ...
            <div class="main__about__content">
                ...
                <div class="row m-0 p-0 d-flex justify-content-center">
                  <div class="main__about__content__left col-md-12 col-lg-8 m-0 p-0">
                    <div>{!! get_field('about_h5', 'option') !!}</div>
                    <h3 class="section-head">{!! get_field('about_h3', 'option') !!}</h3>
                    <p class="main__about__content__left--text section-text">{!! get_field('about_text', 'option') !!}</p>
                    <p class="main__about__content__left--text section-text">{!! get_field('about_text2', 'option') !!}</p>
    ...
    <section class="main__services py-5">
        <div class="container">
            <div class="main__services__text">
                <h5 class="main__services__text--heading section-title"><span class="section-box">{!! get_field('security_h5', 'option') !!}</span></h5>
                <h3 class="main__services__text--sub-heading section-head">{!! get_field('security_h3', 'option') !!}</h3>
                <p class="main__services__text--text section-text">{!! get_field('security_text', 'option') !!}</p>
            </div>
            ...
            <div class="main__services__content">
                ...
                <div class="main__services__content__single-box card col-sm-12 col-md-5 col-lg-3 card p-0">
                        ...
                        <div class="card-body">
                                <div class="card-left">
                                        <h3 class="card-head">{!! the_title(); !!}</h3>
                                        <div class="div-separator">
                                        <hr class="line">
                                        </div>
            ...
            <div class="main__faqs__content">
                <div class="row m-0 p-0">
                    ...
                    <div class="main__faqs__content__left col-lg">
                        <h3 class="main__faqs--heading">{!! get_field('faqs_header1', 'option') !!}</h3>
                        <div class="div-separator">
                            <hr class="line">
                        </div>
                    ...
                    <div class="main__faqs__content__right col-lg">
                        <h3 class="main__faqs--heading">{!! get_field('faqs_header2', 'option') !!}</h3>
                        <div class="div-separator">
                            <hr class="line">
                        </div>
    ...
    <section id="gallery" class="main__gallery py-5">
        <div class="container">
            <div class="main__gallery__text">
                <div>{!! get_field('gallery_h5', 'option') !!}</div>
                <h3 class="main__gallery__text--title">{!! get_field('gallery_h3', 'option') !!}</h3>
                <p class="main__gallery__text--text section-text">{!! get_field('gallery_text', 'option') !!}</p>
            </div>
    ...
    <section class="main__store py-5">
        <div class="container">
            ...
            <div class="main__store__text">
                <div>{!! get_field('store_h5', 'option') !!}</div>
                <h3 class="main__store__text--heading section-head">{!! get_field('store_h3', 'option') !!}</h3>
                <p class="main__store__text--text section-text">{!! get_field('store_text', 'option') !!}</p>
            </div>
            ...
            <div class="main__testimonitals__content">
                <div class="row m-0 p-0">
                    ...
                    <div class="main__testimonitals__content__text col-lg-5">
                        <div>{!! get_field('testimonital_h5', 'option') !!}</div>
                        <h3 class="main__testimonitals__content__text--head section-head">{!! get_field('testimonital_h3', 'option') !!}</h3>
                        <p class="main__testimonitals__content__text--text">{!! get_field('testimonital_text', 'option') !!}</p>
                    </div>
    ...
    <section class="main__team py-5">
        <div class="container">
            <div class="main__team__text">
                <div>{!! get_field('team_h5', 'option') !!}</div>
                <h3 class="main__team__text--head section-head">{!! get_field('team_h3', 'option') !!}</h3>
                <p class="main__team__text--text section-text">{!! get_field('team_text', 'option') !!}</p>
            </div>
    ...
    <section class="main__blog py-5">
        <div class="container">
            <div class="main__blog__text">
                <div>{!! get_field('blog_h5', 'option') !!}</div>
                <h3 class="main__blog__text--head section-head">{!! get_field('blog_h3', 'option') !!}</h3>
                <p class="main__blog__text--text section-text">{!! get_field('blog_text', 'option') !!}</p>
            </div>
